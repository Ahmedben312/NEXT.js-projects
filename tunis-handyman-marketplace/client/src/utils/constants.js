...
export const CATEGORIES_ROUTES = `${API_URL}/categories`;
...
export const GET_ALL_CATEGORIES = `${CATEGORIES_ROUTES}`;
export const SEARCH_CATEGORIES = `${CATEGORIES_ROUTES}/search`;
export const GET_CATEGORY_BY_ID = `${CATEGORIES_ROUTES}`;
export const GET_GIGS_BY_CATEGORY = `${CATEGORIES_ROUTES}/gigs`;
export const ADD_CATEGORY = `${CATEGORIES_ROUTES}`;
export const DELETE_CATEGORY = `${CATEGORIES_ROUTES}`;
